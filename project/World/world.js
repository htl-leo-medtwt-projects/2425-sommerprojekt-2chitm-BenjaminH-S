            ...
            if (clanHighlightElement) {
                if (clanName === "Gojo") {
                    clanHighlightElement.innerHTML = `
                        ...
                        <img src="../Img/World/Kid_Gojo.png" alt="Gojo_Young" style="width: 260px; height: auto; border: 2px solid black;"> 
                        </div>`;
                    ...
                    <div class="naobito_zenin_cont"> <img src="../Img/World/Naobito.png" class="naobito" alt="Naobito" style="width: 260px; height: auto; border: 2px solid black;margin-left: 30vw;"> 
                    <div id="naobito_zenin">Der Ruf des Kamo-Clans ist durch eine düstere Figur getrübt: Kamo Noritoshi (alt), besser bekannt als Kenjaku, ein abtrünniger Jujutsu-Zauberer, der für ethisch verwerfliche Experimente berüchtigt ist. Besonders bekannt ist sein grausames Experiment, 
                    ...
                    <div id="mai_zenin">Der Ruf des Kamo-Clans ist durch eine düstere Figur getrübt: Kamo Noritoshi (alt), besser bekannt als Kenjaku, ein abtrünniger Jujutsu-Zauberer, der für ethisch verwerfliche Experimente berüchtigt ist. Besonders bekannt ist sein grausames Experiment, 
                    bei dem er mit der Fluchgeburt Choso und seinen „Brüdern“ Hybridwesen aus Flüchen und Menschen erschuf.</div>
